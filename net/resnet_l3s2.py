...
class ResNet(nn.Module):
    ...
    def _make_layer(self, block, planes, blocks, shortcut_type, stride=1):
        ...
        for i in range(1, blocks):
            if (i == 5 and blocks == 6) or (i == 1 and blocks == 6) or \
                    (i == 1 and blocks == 4):
                layers.append(cgnl_ls.SpatialCGNL(self.inplanes, int(self.inplanes / 2), use_scale=False, groups=config['num_groups'], flag='long'))
            if (i == 3 and blocks == 6) or (i == 3 and blocks == 4):
                layers.append(cgnl_ls.SpatialCGNL(self.inplanes, int(self.inplanes / 2), use_scale=False, groups=config['num_groups'], flag='short'))
